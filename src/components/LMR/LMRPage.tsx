    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-indigo-600 mb-2">Learning Material Resource (LMR)</h1>
          <p className="text-gray-600">AI-powered document analysis and content generation system</p>
        </div>
        ...
        <div className="p-6">
          {activeTab === 'upload' && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Upload Learning Materials</h3>
